...
export const especialidades: Especialidad[] = [
  {
    ...
    breakQuote: 'Más de 10 años asesorando en cumplimiento laboral y migratorio.',
    ...
    subSpecialties: [
      {
        id: 'derecho-civil',
        name: 'Derecho Civil',
        sidebarImage: '/images/servicios/DerechoCivil.webp',
        breakImage: '/images/servicios/derechocivilexp.webp',
        categories: [
          {
          ...
          },
          {
            ...
            items: [
              { text: 'Conciliación, Negociación, Mediación y Transacción' },
            ]
          }
        ]
      },
      {
        id: 'derecho-penal',
        name: 'Derecho Penal',
        sidebarImage: '/images/servicios/DerechoPenal.webp',
        categories: [
          {
      ...
      },
      {
        ...
        sidebarImage: '/images/servicios/DerechoAdministrativo.webp',
        categories: [
          {
  ...
  },
  {
    ...
    sidebarImage: '/images/servicios/Proteccion de datos Personales Sidebar.webp',
    sidebarObjectPosition: 'center',
    breakImage: '/images/servicios/Proteccion de Datos Personales.webp',
  ...
  },
  {
    ...
    breakImage: '/images/servicios/Propiedad Intelectual.webp',
    ...
    categories: [
      {
        ...
        items: [
          { text: 'Estado de cumplimiento normativo.' },
        ],
      },
      {
        id: 'implementacion',
  ...
  },
  {
    ...
    heroImage: '/images/servicios/Justicia Militar Policial.webp',
    sidebarImage: '/images/servicios/Justicia Militar Policial.webp',
    sidebarObjectPosition: 'center top',
